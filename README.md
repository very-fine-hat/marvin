...
marvin --init rpg       # Or initialize with different domain
...
- Initialize with `marvin --init rpg`
- Set up RPG domain with system-specific guidelines
- Use `marvin rpg` in campaign directories
...
Named after Marvin the Paranoid Android from _The Hitchhiker's Guide to the Galaxy_. Like Marvin, this tool is obsessed with getting things right and might seem a bit over-engineered for the task at hand. But also like Marvin, it's incredibly capable once you get to know it.
